...
#include "imgui/imgui_backends/imgui_impl_glfw.h"
#include "imgui/imgui_backends/imgui_impl_opengl3.h"
...
int main(int argc, char** argv)
{
    ...
    glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_NORMAL); // enable cursor when need UI debug
    ...
    ImGui::StyleColorsDark();                   // set the dark mode
